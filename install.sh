...
install_deps() {
    ...
    $ESCALATION_TOOL pacman -Syyu --needed --noconfirm \
        ...
        lib32-sqlite vulkan-radeon amdvlk lib32-mangohud mangohud pavucontrol qt6ct >/dev/null 2>&1 || { printf "%b\n" "${RED}:: Failed to install dependencies.${RC}"; }
...
setup_sddm_pfp() {
    ...
    $ESCALATION_TOOL cp "$HYPRLAND_DIR/pfps/frieren2.jpg" "/var/lib/AccountsService/icons/$USERNAME"
